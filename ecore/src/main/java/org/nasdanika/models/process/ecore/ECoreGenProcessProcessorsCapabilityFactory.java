...
public class ECoreGenProcessProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenProcessProcessorsFactory(requirement.requirement().context()))));
	}
