package org.nasdanika.models.process.ecore.tests;
...
import org.nasdanika.models.process.ecore.EcoreGenProcessProcessorsFactory;
 ...
 *
 */
public class TestProcessModelDocGen {
	...
	public void testGenerateCrewAIModelDoc() throws IOException, DiagnosticException {
		...
		EcoreGenProcessProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenProcessProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "process.xmi");
		...
		String siteMapDomain = "https://process.models.nasdanika.org";		
