 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.process.impl.TransitionImpl#getOutputs <em>Outputs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends ConnectionImpl<ProcessElement> implements Transition {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.TRANSITION;
	}
	...
	public EList<Artifact> getOutputs() {
		return (EList<Artifact>)eDynamicGet(ProcessPackage.TRANSITION__OUTPUTS, ProcessPackage.Literals.TRANSITION__OUTPUTS, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.TRANSITION__OUTPUTS:
