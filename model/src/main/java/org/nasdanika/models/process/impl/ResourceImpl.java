 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.process.impl.ResourceImpl#getConsumers <em>Consumers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceImpl extends DocumentedNamedStringIdentityImpl implements Resource {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.RESOURCE;
	}
	...
	@Override
	public EList<ResourceConsumer> getConsumers() {
		return (EList<ResourceConsumer>)eDynamicGet(ProcessPackage.RESOURCE__CONSUMERS, ProcessPackage.Literals.RESOURCE__CONSUMERS, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.RESOURCE__CONSUMERS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ProcessPackage.RESOURCE__CONSUMERS:
				getConsumers().clear();
				getConsumers().addAll((Collection<? extends ResourceConsumer>)newValue);
				return;
		}
